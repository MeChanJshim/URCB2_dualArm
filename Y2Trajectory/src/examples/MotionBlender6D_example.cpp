...
int main()
{
    ...
    std::vector<double> velocity = {0.5, 0.5, 0.5};  // Example velocities (first element is ignored)
    ...
    MotionBlender6D blender(position, velocity, angVelLimit, startingTime, lastRestingTime, accelerationTime, samplingTime);
