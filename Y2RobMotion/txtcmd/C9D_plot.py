...
data = np.loadtxt("cmd_continue9D.txt")
...
plt.title("Positions of cmd_continue9D.txt")
...
plt.title("Orientations of cmd_continue9D.txt")
plt.xlabel("Row Index")
plt.ylabel("Value")
plt.legend()
plt.grid(True)
...
plt.title("Forces of cmd_continue9D.txt")
plt.xlabel("Row Index")
plt.ylabel("Value")
plt.legend()
plt.grid(True)
